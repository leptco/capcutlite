  ...
  return useMemo(
    () => ({
      state: {
        ...
        lastSelectedClipId: timeline.lastSelectedClipId,
      ...
      actions: {
        ...
        getTrack: timeline.getTrack,
        getTrackClips: timeline.getTrackClips,
        ...
        toggleClipSelection: timeline.toggleClipSelection,
        selectMultipleClips: timeline.selectMultipleClips,
        selectClipRange: timeline.selectClipRange,
        clearSelection: timeline.clearSelection,
        selectAllClips: timeline.selectAllClips,
        isClipSelected: timeline.isClipSelected,
        getSelectedClips: timeline.getSelectedClips,
